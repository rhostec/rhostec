...
<aside>
                <nav class="navbar navbar-dark ">
                                    <h5>
                                        <em class="contact">Nous somme là pour vous aider</em>
                                    </h5>
                                    <h5>
                                        <em class="contact1">
                                            <a href="https://api.whatsapp.com/send?phone=243977298959">
                                                Nous contacter </a></em>
                                    </h5>
                </nav>
                </aside>
                ...
                <nav class="navbar navbar-dark bg-dark">
                    <ul class="nav justify-content-center">
                        <li class="nav-item">
                            <a class="nav-link " href="tel:+243991044507">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="mailto:rhostechnologie@gmail.com">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.facebook.com/rhostec">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.instagram.com/rhostec">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://api.whatsapp.com/send?phone=243977298959">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.twitter.com/RhosTechnologie">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Rhostec@2023
                            <i class="bi bi-bootstrap-reboot"></i></a>
                            
                        </li>
                        <li class="nav-item">
                            <a class="nav-link disabled">Réaliser par <code>Trésor Mupenda</code>(Rhos)</a>
                        </li>
                    </ul>
